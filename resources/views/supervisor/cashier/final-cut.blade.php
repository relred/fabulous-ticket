<x-app-layout>
    ...
    <div class="w-3/4 p-6 mt-12 mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
        <div class="mx-auto w-full max-w-[550px]">
            <h2 class="text-center mb-5 text-xl font-bold">Ingrese datos de corte final y de supervisor</h2>
            <p class="text-center mb-5 font-bold">Ingrese " 0 " en las casillas que no haya en caja</p>
            <div class="flex bg-amber-500 rounded-lg p-4 mb-4 text-sm text-white" role="alert">
                <svg class="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                <div>
                    <span class="font-medium">Estas a punto de hacer el corte final de caja.</span>
                </div>
            </div>
            ...
            <form action="{{ route('withdraw.final') }}" method="POST">
                @csrf
                <div class="grid grid-cols-6 gap-3 mb-4">
                    ...
                    <label for="cents" class="mt-3 col-start-1 col-end-2 block text-base font-sm text-[#07074D]">
                        Cancelaciones
                    </label>
                    <input
