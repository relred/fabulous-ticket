...
{{--                         @if (Route::has('register'))
            ...
            <div class="max-w-2xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <img src="{{ asset('assets/fab.jpeg') }}" alt="Fabolous ticket">
                </div>
                <div class="flex justify-center">

                    <a href="{{ route('login') }}" class="hover:shadow-form hover:bg-teal-600 rounded-md bg-teal-500 py-3 px-8 text-base font-semibold text-white outline-none">
