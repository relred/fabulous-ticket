                ...
                <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                    <div class="rounded-lg md:w-1/2">
                            <div class="justify-between mb-3 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
                                <img src="{{ asset('assets/tickets/5.png') }}" alt="product-image" class="w-full rounded-lg sm:w-14" />
                                <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                <div class="mt-5 sm:mt-1">
                                    <h2 class="text-xl font-bold text-gray-900">Boleto VIP</h2>
                                </div>
                                <div class="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                                    <div class="flex items-center space-x-4">
                                    <div class="flex items-center border-gray-100">
                                        <kbd wire:click="ticketMinus" class="px-2 py-1 text-center text-base font-bold text-gray-800 bg-gray-100 border border-gray-200 rounded-l-md dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500 select-none cursor-pointer hover:bg-gray-300">-</kbd>
                                        <span class="font-extrabold bg-gray-100 py-1 px-3.5"> {{ $tickets }} </span>
                                        <kbd wire:click="ticketPlus" class="px-2 py-1 text-center text-base font-bold text-gray-800 bg-gray-100 border border-gray-200 rounded-r-md dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500 select-none cursor-pointer hover:bg-gray-300">+</kbd>
                                    </div>
                                    <p class="text-sm">$ 500.00</p>
                                    </div>
                                </div>
                                </div>
                            </div>
                  ...
                  <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/2">
                    ...
                    <div class="grid grid-cols-1 gap-0 mt-7">
                        @if ($tickets > 0)
                            <button wire:click="storeSale" class="mt-6 w-full rounded-md bg-teal-500 py-1.5 font-medium text-blue-50 hover:bg-teal-600">Finalizar cobro</button>
                        @endif
                    </div>
                  </div>
                </div>
